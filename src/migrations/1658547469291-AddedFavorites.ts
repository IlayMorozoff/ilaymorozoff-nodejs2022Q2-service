...
export class AddedFavorites1658547469291 implements MigrationInterface {
  name = 'AddedFavorites1658547469291';

  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `CREATE TABLE "favorites" ("id" SERIAL NOT NULL, "artists" uuid NOT NULL, "albums" uuid NOT NULL, "tracks" uuid NOT NULL, CONSTRAINT "PK_890818d27523748dd36a4d1bdc8" PRIMARY KEY ("id"))`,
    );
